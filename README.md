...
docker run -p 1521:1521 -p 5500:5500 -e ORACLE_SID=atscale -e ORACLE_PWD=atscale -e ORACLE_CDB=atscale -e ORACLE_MEM=2000 -v /opt/oracle/oradata -d davarski/oracle12c-r1-ee
```
